...
This is purpose of understanding .. please discuss with iplon DevOps team before implementing or modifying the environment.
Refer (https://github.com/kubernetes/ingress-nginx) Ingress controller for Kubernetes using NGINX as a reverse proxy and load balancer
